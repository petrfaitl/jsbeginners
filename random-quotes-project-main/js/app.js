...
const quotes = [{
    ...
    quote: "The price of anything is the amount of life you exchange for it.", author: "David Thoreau"
}, {
...
const randomQuote = function(){
    ...
    quoteText.textContent = quotes[ran].quote;
    author.textContent = quotes[ran].author;
}
